...
const Hero = () => {
  return (
    <section
      className="relative w-full min-h-screen flex flex-col md:flex-row items-center justify-between px-6 md:px-12 overflow-hidden bg-cover bg-center"
    ...
    >
      <div className="max-w-3xl text-center md:text-left relative z-10 ml-12">
        ...
        <p className="text-gray-900 mt-6 text-xl">
        ...
        <button className="mt-12 bg-green-600 hover:bg-green-700 text-white font-semibold w-[235px] h-[60px] px-[28px] py-[16px] rounded-lg shadow-lg transition">
          Book Your Tent Now!
        </button>
      </div>
